...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    .constant('SatellizerConfig', {
      ...
      cordova: false,
      baseUrl: '/',
      loginUrl: fyipeUrl+'/auth/login',
      signupUrl: fyipeUrl+'/auth/signup',
      unlinkUrl: fyipeUrl+'/auth/unlink/',
      tokenName: 'token',
